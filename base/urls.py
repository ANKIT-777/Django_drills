...
from .views import index_view, matches_played_per_year,matches_won_per_team_per_year,extra_runs_conceded_per_team_in_2016,top_10_economical_bowler_in_2015,matches_played_view,matches_won_per_team_per_year_view,extra_runs_conceded_per_team_in_2016_view
...
urlpatterns = [
    ...
    extra_runs_conceded_per_team_in_2016_view
